<?php /*a:6:{s:60:"D:\wamp64\www\study\application\admin\view\pubsix\index.html";i:1551349031;s:52:"D:\wamp64\www\study\application\admin\view\main.html";i:1548052101;s:54:"D:\wamp64\www\study\application\admin\view\header.html";i:1546943078;s:55:"D:\wamp64\www\study\application\admin\view\lefttop.html";i:1546943105;s:52:"D:\wamp64\www\study\application\admin\view\left.html";i:1547472649;s:53:"D:\wamp64\www\study\application\admin\view\right.html";i:1547710419;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="row">
							<div class="col-sm-6" style="width:100%">
								<div style="display:inline">
									<a href="<?php echo url('admin/Pubsix/add',['navid'=>$navid,'level'=>$level,'misparent'=>$misparent,'tbname'=>$tbname]); ?>"><i class="icon-plus" style="margin-right: 0.5%"></i>添加记录</a>
						...
						<table class="table table-striped table-bordered table-hover" style="padding:1px 1px">
							<thead>
								<tr style="height:45px">
									...
									<th style="width:43%;padding:8px 3px;text-align: center">标题</th>	
									...
									<td style="padding:0px;line-height: 0;vertical-align: middle;text-align: center">
										<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
											<div id="" style="display:inline">
												<a class="blue" href="<?php echo url('admin/Pubsix/update',['navid'=>$navid,'level'=>$level,'misparent'=>$misparent,'tbname'=>$tbname,'id'=>$list['id']]); ?>" style="margin:0px">
												...
												<a class="red" href="javascript:web_html(<?php echo htmlentities($list['id']); ?>,'id','<?php echo htmlentities($table); ?>')" style="margin:0px">
...
//生成静态页
function web_html(id , idfield , tbname){
	$.ajax({
		url: "<?php echo url('admin/Pubsix/web_html'); ?>",
		data: {'id':id,'idfield':idfield,'tbname':tbname },
		datatype: 'json',
		type: 'POST',
		async: false,
