<?php /*a:6:{s:58:"D:\wamp64\www\study\application\admin\view\pubsix\add.html";i:1547992857;s:52:"D:\wamp64\www\study\application\admin\view\main.html";i:1548052101;s:54:"D:\wamp64\www\study\application\admin\view\header.html";i:1546943078;s:55:"D:\wamp64\www\study\application\admin\view\lefttop.html";i:1546943105;s:52:"D:\wamp64\www\study\application\admin\view\left.html";i:1547472649;s:53:"D:\wamp64\www\study\application\admin\view\right.html";i:1547710419;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="col-xs-12">
							<form class="form-horizontal" style="margin-top: 20px" id="myform" name="myform" method="post" action="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="<?php echo htmlentities($list['title']); ?>" name="<?php echo htmlentities($list['title']); ?>" placeholder="请输入标题" style="width:90%"  required class="col-xs-10 col-sm-5" onblur="checkObj(this,0,0,'',1,'<?php echo htmlentities($tbname); ?>','<?php echo htmlentities($list['title']); ?>','',0)"/><span style="color:red">*</span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control" style="width:41.5%;padding:4px 0px" name="<?php echo htmlentities($list['onfield']); ?>" id="<?php echo htmlentities($list['onfield']); ?>">
											<option value="">&nbsp;请选择类别</option>
											<?php if(is_array($link_lists) || $link_lists instanceof \think\Collection || $link_lists instanceof \think\Paginator): $i = 0; $__LIST__ = $link_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link_list): $mod = ($i % 2 );++$i;?>
								...
								<div class="form-group">
									...
									<textarea id="<?php echo htmlentities($list['content']); ?>" name="<?php echo htmlentities($list['content']); ?>" style="width:50%; height:200px;" hidden="hidden"></textarea>									
								</div>
...
<script>
	$("#button").click(function (){
		...
		if(!name){
			...
			$.ajax({
				url: "<?php echo url('admin/Pubsix/add'); ?>",
