<?php /*a:6:{s:61:"D:\wamp64\www\study\application\admin\view\pubzero\index.html";i:1578042353;s:52:"D:\wamp64\www\study\application\admin\view\main.html";i:1576633336;s:54:"D:\wamp64\www\study\application\admin\view\header.html";i:1546943078;s:55:"D:\wamp64\www\study\application\admin\view\lefttop.html";i:1546943105;s:52:"D:\wamp64\www\study\application\admin\view\left.html";i:1567673264;s:53:"D:\wamp64\www\study\application\admin\view\right.html";i:1547710419;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="row">
							<div class="col-sm-6" style="width:100%">
								<div style="display:inline">
									<a href="<?php echo url('admin/Pubzero/add',['navid'=>$navid,'level'=>$level,'misparent'=>$misparent,'tbname'=>$tbname]); ?>"><i class="icon-plus" style="margin-right: 0.5%"></i>添加记录</a>
								</div>											
							</div>													
						</div>
						<table class="table table-striped table-bordered table-hover" style="padding:1px 1px">
							<thead>
								<tr style="height:45px">
									...
									<th style="width:20%;padding:8px 3px;text-align: center">分类名称</th>																									
									<th style="width:55%;padding:8px 3px;text-align: center">描述</th>
							...
							<tbody>
								...
								<tr style="height:40px" id="<?php echo htmlentities($table); ?><?php echo htmlentities($list['id']); ?>">
									...
									<td style="vertical-align:middle;padding:4px 1px;" id="content<?php echo htmlentities($list['id']); ?>">
										<input type="text" value="<?php echo htmlentities(getSubstr($list['content'],0,100)); ?>" onblur="updateObj(this,'<?php echo htmlentities($list['content']); ?>','<?php echo htmlentities($table); ?>','content','<?php echo htmlentities($list['id']); ?>','id',1)" style="color:#393939;width:100%;border:none; background:transparent;padding: 0px;font-size: 13px;height: 30px;"/>
									</td>
