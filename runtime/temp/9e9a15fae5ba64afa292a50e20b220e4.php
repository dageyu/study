<?php /*a:6:{s:60:"D:\wamp64\www\study\application\admin\view\pubone\index.html";i:1550399312;s:52:"D:\wamp64\www\study\application\admin\view\main.html";i:1548052101;s:54:"D:\wamp64\www\study\application\admin\view\header.html";i:1546943078;s:55:"D:\wamp64\www\study\application\admin\view\lefttop.html";i:1546943105;s:52:"D:\wamp64\www\study\application\admin\view\left.html";i:1547472649;s:53:"D:\wamp64\www\study\application\admin\view\right.html";i:1547710419;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="row">
							<div class="col-sm-6" style="width:100%;">
								<div style="display:inline">
									<a href="<?php echo url('admin/Pubone/add',['navid'=>$navid,'level'=>$level,'misparent'=>$misparent,'tbname'=>$tbname]); ?>"><i class="icon-plus" style="margin-right: 0.5%"></i>添加记录</a>
							...
							<table class="table table-striped table-bordered table-hover" style="padding:1px 1px">
								<thead>
									<tr style="height:45px">
										...
										<th style="width:21%;padding:8px 3px;text-align: center">名称</th>																									
										...
										<th style="width:11%;padding:8px 3px;text-align: center">
								...
								<tbody id="kbTable">
									...
									<tr id="<?php echo htmlentities($table); ?><?php echo htmlentities($list['id']); ?>" style="display: table-row;" data-obj="">
										...
										<td style="vertical-align:middle;padding:4px 1px;" id="zn_name<?php echo htmlentities($list['id']); ?>">
											<input type="text" value="<?php echo htmlentities(getSubstr($list['zn_name'],0,28)); ?>" onblur="updateObj(this,'<?php echo htmlentities($list['zn_name']); ?>','<?php echo htmlentities($table); ?>','zn_name','<?php echo htmlentities($list['id']); ?>','id',1)" style="color:#393939;width:100%;border:none; background:transparent;padding: 0px;font-size: 13px;height: 30px;"/>
										</td>
										...
										<td class="hidden-480" style="vertical-align:middle;padding:4px 1px;text-align: center;" id="addtime<?php echo htmlentities($list['id']); ?>">
											<?php echo htmlentities(date("y-m-d H:i",!is_numeric($list['addtime'])? strtotime($list['addtime']) : $list['addtime'])); ?>
										</td>
										<td style="padding:0px;line-height: 0;vertical-align: middle;text-align: center">
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
												<div id="" style="display:inline">
													<a class="blue" href="<?php echo url('admin/Pubone/update',['navid'=>$navid,'level'=>$level,'misparent'=>$misparent,'tbname'=>$tbname,'id'=>$list['id']]); ?>" style="margin:0px">
						...
						<div>
							<div style="float:left;margin-left:15px;">
								<label>
									...
									<span class="lbl" style="font-size: 12px">全选</span>
								</label>
								<label style="margin-left:10px">
									<input type="checkbox" class="ace" id="checkedpart" />
									<span class="lbl" style="font-size: 12px">反选</span>
								</label>
							...
							<div class="page-box page-laypage page-laypage-default" style="float:right;">
								...
								<span class="page-laypage-limits">
									<select id="sel_page_codes" onchange="pageFun(this.value,'#sel_text');">
										...
										<option value="40" selected="">40条/页</option>
