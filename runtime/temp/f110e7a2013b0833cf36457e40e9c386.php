<?php /*a:6:{s:60:"D:\wamp64\www\study\application\admin\view\pubseven\add.html";i:1555902223;s:52:"D:\wamp64\www\study\application\admin\view\main.html";i:1576633336;s:54:"D:\wamp64\www\study\application\admin\view\header.html";i:1546943078;s:55:"D:\wamp64\www\study\application\admin\view\lefttop.html";i:1546943105;s:52:"D:\wamp64\www\study\application\admin\view\left.html";i:1567673264;s:53:"D:\wamp64\www\study\application\admin\view\right.html";i:1547710419;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="col-xs-12">
							<form class="form-horizontal" style="margin-top: 20px" id="myform" name="myform" method="post" action="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="<?php echo htmlentities($list['title']); ?>" name="<?php echo htmlentities($list['title']); ?>" placeholder="请输入名称"  style="width:90%" class="col-xs-10 col-sm-5" onblur="checkObj(this,0,0,'',1,'<?php echo htmlentities($tbname); ?>','<?php echo htmlentities($list['title']); ?>','',0)"/><span style="color:red">*</span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
...
<script>
	$("#button").click(function (){
		...
		if(!name){
			...
			$.ajax({
				url: "<?php echo url('admin/Pubseven/add'); ?>",
