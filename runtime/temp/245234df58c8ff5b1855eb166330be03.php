<?php /*a:6:{s:61:"D:\wamp64\www\study\application\admin\view\pubone\update.html";i:1548914180;s:52:"D:\wamp64\www\study\application\admin\view\main.html";i:1548052101;s:54:"D:\wamp64\www\study\application\admin\view\header.html";i:1546943078;s:55:"D:\wamp64\www\study\application\admin\view\lefttop.html";i:1546943105;s:52:"D:\wamp64\www\study\application\admin\view\left.html";i:1547472649;s:53:"D:\wamp64\www\study\application\admin\view\right.html";i:1547710419;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="col-xs-12">
							<form class="form-horizontal" style="margin-top: 20px" id="myform" name="myform" method="post" action="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="name" name="name" placeholder="请输入名称"  value="<?php echo htmlentities($list['name']); ?>" required class="col-xs-10 col-sm-5" onblur="updateCheckObj(this,'<?php echo htmlentities($list['name']); ?>','<?php echo htmlentities($tbname); ?>','name',<?php echo htmlentities($list['id']); ?>,'id')"/><span style="color:red">*</span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
...
<script>
	$("#button").click(function (){
		...
		if(!name){
			...
			$.ajax({
				url: "<?php echo url('admin/Pubone/update'); ?>",
