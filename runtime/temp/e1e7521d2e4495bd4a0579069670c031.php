			...
			$.ajax({
				...
				success:function(res){
					if(res.status == 1){
						...
						location.href = "<?php echo url('admin/Role/index'); ?>";
						return
					} else {
