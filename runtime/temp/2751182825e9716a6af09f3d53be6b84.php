				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="col-xs-12">
							...
							<?php if($data['tbname'] == 'first_module'): ?>
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" style="width:10%"> 模块名称 </label>
									<div class="col-sm-9">
										<input type="text" id="model" name="fm_name" placeholder="请输入模块名称" maxlength="30" required class="col-xs-10 col-sm-5" onblur="checkObj(this,0,0,'',1,'<?php echo htmlentities($data['tbname']); ?>','<?php echo htmlentities($data['field']); ?>','',0)"/><span style="color:red">*</span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control" style="width:41.5%;padding:4px 0px" name="fm_controller" id="controller">
											...
											<?php if(is_array($dirs) || $dirs instanceof \think\Collection || $dirs instanceof \think\Paginator): $i = 0; $__LIST__ = $dirs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dir): $mod = ($i % 2 );++$i;?>
											<option value="<?php echo htmlentities($dir); ?>"><?php echo htmlentities($dir); ?></option>
								...
								<?php else: if($data['tbname'] == 'second_module'): ?>
										<input type="text" id="fm_id" name="fm_id" value="<?php echo htmlentities($data['parent_id']); ?>" hidden="hidden" />
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" style="width:10%"> 模块名称 </label>
											<div class="col-sm-9">
												<input type="text" id="model" name="sm_name" placeholder="请输入模块名称" maxlength="30" required class="col-xs-10 col-sm-5" onblur="checkObj(this,0,0,'',1,'<?php echo htmlentities($data['tbname']); ?>','<?php echo htmlentities($data['field']); ?>','fm_id',<?php echo htmlentities($data['parent_id']); ?>)"/><span style="color:red">*</span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
									...
									<?php else: ?>
											<input type="text" id="sm_id" name="sm_id" value="<?php echo htmlentities($data['parent_id']); ?>" hidden="hidden" />
											<div class="space-4"></div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" style="width:10%"> 模块名称 </label>
												<div class="col-sm-9">
													<input type="text" id="model" name="tm_name" placeholder="请输入模块名称" maxlength="30" required class="col-xs-10 col-sm-5" onblur="checkObj(this,0,0,'',1,'<?php echo htmlentities($data['tbname']); ?>','<?php echo htmlentities($data['field']); ?>','sm_id',<?php echo htmlentities($data['parent_id']); ?>)"/><span style="color:red">*</span>
												</div>
											</div>
											<div class="space-4"></div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select class="form-control" style="width:41.5%;padding:4px 0px" name="tbname" id="tbname">
														...
														<?php if(is_array($tables) || $tables instanceof \think\Collection || $tables instanceof \think\Paginator): $i = 0; $__LIST__ = $tables;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?>
														<option value="<?php echo htmlentities($table['Name']); ?>"><?php echo htmlentities($table['Name']); ?></option>
														<?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
											</div>
			...
			$.ajax({
				...
				success:function(res){
					if(res.status == 1){
						...
						location.href = "<?php echo url('admin/menu/index'); ?>";
						return
					} else {
