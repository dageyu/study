<?php /*a:1:{s:59:"D:\wamp64\www\study\application\admin\view\login\index.html";i:1546617440;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8" />
											...
											<fieldset>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" class="form-control" placeholder="Username" id="admin_name" name="admin_name"/>
														<i class="icon-user"></i>
													</span>
												</label>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="password" class="form-control" placeholder="Password" id="admin_password" name="admin_password"/>
														<i class="icon-lock"></i>
													</span>
												</label>
												<div class="space"></div>
