<?php /*a:6:{s:59:"D:\wamp64\www\study\application\admin\view\pubzero\add.html";i:1547897031;s:52:"D:\wamp64\www\study\application\admin\view\main.html";i:1548052101;s:54:"D:\wamp64\www\study\application\admin\view\header.html";i:1546943078;s:55:"D:\wamp64\www\study\application\admin\view\lefttop.html";i:1546943105;s:52:"D:\wamp64\www\study\application\admin\view\left.html";i:1547472649;s:53:"D:\wamp64\www\study\application\admin\view\right.html";i:1547710419;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="col-xs-12">
							<form class="form-horizontal" style="margin-top: 20px" id="myform" name="myform" method="post" action="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea id="<?php echo htmlentities($list['content']); ?>" name="<?php echo htmlentities($list['content']); ?>" style="width:41.666%; height:100px;" ></textarea>
									</div>
								</div>
...
<script>
	$("#button").click(function (){
		...
		if(!name){
			...
			$.ajax({
				url: "<?php echo url('admin/Pubzero/add'); ?>",
	...
	function jump(){
		location.href = "<?php echo url('admin/Pubzero/index',['navid'=>$navid,'level'=>$level,'misparent'=>$misparent,'tbname'=>$tbname]); ?>";
	}
</script>
