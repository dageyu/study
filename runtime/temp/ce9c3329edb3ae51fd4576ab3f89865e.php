						...
						<div class="col-xs-12">
							<form class="form-horizontal" style="margin-top: 20px" id="myform" name="myform" method="post" action="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="title" name="title" placeholder="请输入标题"  value="<?php echo htmlentities($list['title']); ?>" required class="col-xs-10 col-sm-5" onblur="updateCheckObj(this,'<?php echo htmlentities($list['title']); ?>','<?php echo htmlentities($tbname); ?>','title',<?php echo htmlentities($list['id']); ?>,'id')"/><span style="color:red">*</span>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="zn_name" name="zn_name" placeholder="请输入中文释义" class="col-xs-10 col-sm-5" style="width:90%" value="<?php echo htmlentities($list['zn_name']); ?>"/>
									</div>
								</div>
								<div class="space-4"></div>
								<div class="form-group">
...
<script>
	$("#button").click(function (){
		...
		if(!name){
			...
			$.ajax({
				url: "<?php echo url('admin/Pubfour/update'); ?>",
	...
	function jump(){
		location.href = "<?php echo url('admin/Pubfour/index',['navid'=>$navid,'level'=>$level,'misparent'=>$misparent,'tbname'=>$tbname]); ?>";
	}
</script>
