...
INSERT INTO `study_first_module` VALUES (6, 7, 'fab fa-php', 'Php管理', 'P', 'index', 1, 1, 1545395468, 0, '', 1, 0);
...
) ENGINE=MyISAM AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模块管理二级表';
...
INSERT INTO `study_second_module` VALUES (34, 16, 1, 'icon-eur', '分类管理', 'Pubzero', 'index', 1, 0, 1546403608, 0, 'stusy_others_type', 1, 0);
