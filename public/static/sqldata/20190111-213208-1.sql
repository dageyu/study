...
INSERT INTO `study_admin` VALUES (2, 'cuiyu1478', '07a0ac3365a4efd51b90556101f08481', 'cuiyu1478@163.com', '小青龙', 1547048227, '::1', '', 1547202285, '::1', 1, 1, 1543809193, '长生，你妈喊你回家吃饭了', 1, 'ad7f1e6a7e0f6bc94df9b4a373435a85', '590abff594f60a1216d4ca9fa1b772c1', 1547205885, 0);
...
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模块管理一级表';

-- -----------------------------
-- Records of study_first_module
-- -----------------------------
INSERT INTO `study_first_module` VALUES (1, 1, 'icon-dashboard', '控制平台', 'Index', 'index', 1, 0, 1545386748, 0, '', 0, 1);
INSERT INTO `study_first_module` VALUES (2, 2, 'icon-user', '用户管理', 'Admin', 'index', 1, 0, 1545381827, 0, 'study_admin', 0, 1);
INSERT INTO `study_first_module` VALUES (3, 3, 'icon-key', '修改密码', 'Password', 'index', 1, 0, 1545381829, 0, '', 0, 1);
...
INSERT INTO `study_first_module` VALUES (6, 7, 'fab fa-php', 'Php管理', 'PhpSource', 'index', 1, 1, 1545395468, 0, '', 1, 0);
...
-- -----------------------------
-- Records of study_php_develop_plug
-- -----------------------------
INSERT INTO `study_php_develop_plug` VALUES (1, 1, 0, 'dddd', 'ddd', '&lt;p&gt;ddd&lt;br&gt;&lt;/p&gt;', 1, 1547206225, 1, 1, 0);
...
-- -----------------------------
-- Records of study_php_develop_type
-- -----------------------------
INSERT INTO `study_php_develop_type` VALUES (1, 'dddd', 'dddd', 1547206114, 0);
...
CREATE TABLE `study_php_errors` (
  ...
  `is_delete` tinyint(1) DEFAULT '0' COMMENT '是否删除  默认0否1是',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='php报错总结表';

-- -----------------------------
-- Records of study_php_errors
-- -----------------------------
INSERT INTO `study_php_errors` VALUES (1, 1, '使用composer安装成功后，start.php不', '&lt;h1&gt;dddd&lt;/h1&gt;', 1, 1547142800, 1, 1, 0);
...
-- -----------------------------
INSERT INTO `study_php_functions` VALUES (1, 1, 'substr()', '截取字符串,返回字符串的一部分', '&lt;h4&gt;语法：&lt;span style=&quot;font-weight: bold;&quot;&gt;substr(string,start,length)&lt;/span&gt;&lt;/h4&gt;&lt;p&gt;sssssssss&lt;/p&gt;', 1, 1547140585, 1, 1, 0);
...
) ENGINE=MyISAM AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模块管理二级表';
...
INSERT INTO `study_second_module` VALUES (67, 13, 6, 'icon-remove', '报错总结', 'Pubsix', 'index', 0, 0, 1547114898, 0, 'study_software_errors', 0, 0);
