...
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模块管理一级表';

-- -----------------------------
-- Records of study_first_module
-- -----------------------------
INSERT INTO `study_first_module` VALUES (1, 1, 'icon-dashboard', '控制平台', 'Index', 'index', 1, 0, 1545386748, 0);
INSERT INTO `study_first_module` VALUES (2, 2, 'icon-user', '用户管理', 'Admin', 'list', 1, 0, 1545381827, 0);
INSERT INTO `study_first_module` VALUES (3, 3, 'icon-key', '修改密码', 'Password', 'change', 1, 0, 1545381829, 0);
INSERT INTO `study_first_module` VALUES (4, 4, 'fas fa-database', '数据管理', 'Tools', 'index', 1, 1, 1545391981, 0);
INSERT INTO `study_first_module` VALUES (5, 5, 'fas fa-user-tie', '权限管理', 'Power', 'index', 1, 0, 1545381833, 0);
INSERT INTO `study_first_module` VALUES (6, 6, 'fab fa-php', 'Php管理', 'Php', 'index', 1, 1, 1545395468, 0);
INSERT INTO `study_first_module` VALUES (7, 7, 'fab fa-connectdevelop', '开发工具', 'Develop', 'index', 1, 1, 1545395467, 0);
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模块管理二级表';
...
INSERT INTO `study_second_module` VALUES (3, 6, 1, 'fab fa-themeco', 'Php源码管理', 'Php', 'index', 1, 1, 1545395467, 0);
INSERT INTO `study_second_module` VALUES (4, 7, 1, 'fas fa-clipboard-list', '分类管理', 'type', 'index', 1, 1, 1545395464, 0);
INSERT INTO `study_second_module` VALUES (5, 6, 2, 'fas fa-cog', 'Php环境配置', 'dddd', 'index', 1, 1, 1545813458, 0);
INSERT INTO `study_second_module` VALUES (6, 6, 4, 'ffff', 'ddddd', 'ffff', 'index', 1, 1, 0, 0);
INSERT INTO `study_second_module` VALUES (7, 6, 3, 'ggg', 'fff', 'ddd', 'index', 0, 0, 0, 0);
INSERT INTO `study_second_module` VALUES (8, 6, 5, 'ss', 'dd', 'gg', 'index', 0, 0, 0, 0);
INSERT INTO `study_second_module` VALUES (9, 6, 0, 'rr', 'hh', 'ff', 'index', 0, 0, 0, 0);
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模块管理三级表';

-- -----------------------------
-- Records of study_three_module
-- -----------------------------
INSERT INTO `study_three_module` VALUES (1, 4, 1, 'fab fa-foursquare', '函数管理', 'type', 'index', 1, 1545395461, 0);
INSERT INTO `study_three_module` VALUES (2, 4, 2, 'fas fa-plug', '插件使用', 'type', 'index', 1, 1545394592, 0);
