...
CREATE TABLE `study_admin`  (
  ...
  `admin_email` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '邮箱',
  `admin_nickname` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '昵称',
  `admin_time` int(11) NULL DEFAULT 0 COMMENT '上次登录时间',
  `admin_ip` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '上次登录ip',
  `admin_image` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '管理员头像',
  `admin_lasttime` int(11) NULL DEFAULT 0 COMMENT '最后登录时间',
  `admin_lastip` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '最后登录ip',
  ...
  `admin_addtime` int(10) NULL DEFAULT 0 COMMENT '注册时间',
  `admin_secret` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '口令',
  `parent_id` tinyint(4) NULL DEFAULT 0 COMMENT '介绍人id',
  `identifier` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '第二身份标识',
  `token` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '永久登录标识',
  `timeout` int(10) NULL DEFAULT 0 COMMENT '永久登录超时时间',
  PRIMARY KEY (`admin_id`) USING BTREE,
  UNIQUE INDEX `admin_email`(`admin_email`) USING BTREE,
  INDEX `admin_vip`(`admin_vip`) USING BTREE
...
CREATE TABLE `study_csst_act`  (
  ...
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用手册',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
...
CREATE TABLE `study_csst_plug_errors`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解决方法',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
  `is_ok` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否解决  默认0否1是',
...
CREATE TABLE `study_csst_plug_questions`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解决方案',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
  `is_ok` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否解决  默认0否1是',
...
CREATE TABLE `study_csst_plug_specials`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用方法',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
  `is_ok` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否解决  默认0否1是',
...
CREATE TABLE `study_csst_plug_type`  (
  ...
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '详述',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `study_first_module`  (
  ...
  `fm_sort` tinyint(4) NULL DEFAULT 0 COMMENT '显示位置排序',
  `fm_icon` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '前置标签',
  `fm_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模块名称',
  `fm_controller` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '控制器名称/文件夹名称',
  `fm_method` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '方法名称  默认输出页',
  `fm_state` tinyint(1) NOT NULL DEFAULT 0 COMMENT '显示状态  默认0否1是',
  `is_parent` tinyint(1) NOT NULL DEFAULT 0 COMMENT '有无子类  默认0否1是',
  `fm_addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  PRIMARY KEY (`fm_id`) USING BTREE,
  INDEX `fm_sort`(`fm_id`, `fm_sort`) USING BTREE
...
CREATE TABLE `study_htmlf_attrs`  (
  ...
  `zn_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用手册',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_js_errors`  (
  `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '错误标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解决方法',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_js_extends`  (
  `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '扩展知识名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '详述',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_js_frame_event`  (
  ...
  `zn_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '事件中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用手册',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_js_nouns`  (
  `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名词名称',
  `zn_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用手册',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_js_operators`  (
  `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '符号名称',
  `zn_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '符号中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用手册',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_js_questions`  (
  `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '问题名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解决问题方法',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
  `is_ok` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否解决  默认0否1是',
...
CREATE TABLE `study_others_questions`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '问题名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解决问题方法',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_php_errors`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '错误标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解决办法',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
  `is_ok` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否解决  默认0否1是',
...
CREATE TABLE `study_php_frame_functions`  (
  ...
  `pft_id` tinyint(4) NOT NULL COMMENT '分类id',
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '函数名称',
  `zn_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '函数中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用手册',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_php_functions`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '函数名称',
  `zn_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '函数中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用说明',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
  `is_ok` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否解决  默认0否1是',
...
CREATE TABLE `study_php_lamp`  (
  ...
  `zn_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '说明',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_php_operators`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '符号名称',
  `zn_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '符号中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用说明',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_php_questions`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '问题名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '解决问题办法',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
  `is_ok` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否解决  默认0否1是',
...
CREATE TABLE `study_role`  (
  ...
  `role_addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
...
CREATE TABLE `study_second_module`  (
  ...
  `fm_id` tinyint(4) NOT NULL COMMENT '一级模块id',
  `sm_sort` tinyint(4) NULL DEFAULT 0 COMMENT '显示位置排序',
  `sm_icon` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '前置标签',
  `sm_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二级模块名称',
  `sm_controller` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '控制器名称/文件夹名称',
  `sm_method` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '方法名称  默认输出页',
  `sm_state` tinyint(1) NOT NULL DEFAULT 0 COMMENT '显示状态  默认0否1是',
  `is_parents` tinyint(1) NOT NULL DEFAULT 0 COMMENT '有无子类  默认0否1是',
  `sm_addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
...
INSERT INTO `study_second_module` VALUES (6, 6, 4, 'ffff', 'ddddd', 'ffff', '', 1, 1, NULL);
INSERT INTO `study_second_module` VALUES (7, 6, 3, 'ggg', 'fff', 'ddd', '', 0, 0, NULL);
INSERT INTO `study_second_module` VALUES (8, 6, 5, 'ss', 'dd', 'gg', NULL, 0, 0, NULL);
INSERT INTO `study_second_module` VALUES (9, 6, 0, 'rr', 'hh', 'ff', '', 0, 0, NULL);
...
CREATE TABLE `study_system_operators`  (
  ...
  `sort` smallint(6) NOT NULL DEFAULT 0 COMMENT '排序',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '符号名称',
  `zn_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '符号中文名称',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用手册',
  `checked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '验证状态  默认0否1是',
  `addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
  `sign` tinyint(1) NOT NULL DEFAULT 0 COMMENT '标记  默认0普通1重要',
...
CREATE TABLE `study_three_module`  (
  ...
  `sm_id` tinyint(4) NOT NULL COMMENT '二级模块id',
  `tm_sort` tinyint(4) NULL DEFAULT 0 COMMENT '显示位置排序',
  `tm_icon` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '前置标签',
  `tm_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '三级模块名称',
  `tm_controller` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '控制器名称/文件夹名称',
  `tm_method` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '方法名称  默认输出页',
  `tm_state` tinyint(1) NOT NULL DEFAULT 0 COMMENT '显示状态  默认0否1是',
  `tm_addtime` int(10) NULL DEFAULT 0 COMMENT '添加时间',
