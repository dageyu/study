...
class Pubthree extends Base {
    ...
    public function index(){
        ...
        $lists = Db::table($tbname)->field('id,sort,name,checked,addtime,sign,is_ok')->where('is_delete',0)->order('sort asc,addtime desc')->select();
    ...
    public function update(){
        if($this->request->isPost()){
            ...
            $list = Db::name($tbname)->field('id,name,content')->where('id',$data['id'])->find();
