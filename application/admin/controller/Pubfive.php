...
class Pubfive extends Base {
    ...
    public function index(){
        ...
        $lists = Db::table($tbname)->field($tbname.".id as id,sort,".$tbname.".name as name,zn_name,checked,".$tbname.".addtime as addtime,sign,is_ok,".Config::get('database.prefix').$list['linkfield'])
    ...
    public function update(){
        if($this->request->isPost()){
            ...
            $list = Db::name($tbname)->field('id,name,zn_name,content,'.$link_field.' as type_id')->where('id',$data['id'])->find();
